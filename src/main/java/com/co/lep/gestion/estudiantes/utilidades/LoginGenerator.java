...
public class LoginGenerator {
	...
	public static List<String> generarLogins(UsuarioDTO usuarioDTO, List<String> codDocentes) {
		String nombre = usuarioDTO.getPrimerNombre().trim().split(" ")[0].toLowerCase().replaceAll("\\s+", "");
        String apellido = usuarioDTO.getPrimerApellido().trim().split(" ")[0].toLowerCase().replaceAll("\\s+", "");
